    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/produtos", "/api/produtos/**").hasAnyRole("ADMIN", "GERENTE", "GERENCIA_MATRIZ")
                        .requestMatchers(HttpMethod.PATCH, "/api/lojas", "/api/lojas/**").hasAnyRole("ADMIN", "GERENTE", "GERENCIA_MATRIZ")
                        .requestMatchers(HttpMethod.PATCH, "/api/produtos", "/api/produtos/**").hasAnyRole("ADMIN", "GERENTE", "GERENCIA_MATRIZ")
                        .requestMatchers(HttpMethod.DELETE, "/api/lojas", "/api/lojas/**").hasAnyRole("ADMIN", "GERENTE", "GERENCIA_MATRIZ")
                        .requestMatchers(HttpMethod.DELETE, "/api/produtos", "/api/produtos/**").hasAnyRole("ADMIN", "GERENTE", "GERENCIA_MATRIZ")
